...
const AIInsightsPage = () => {
  const [messages, setMessages] = useState([
    { 
      role: 'system', 
      content: 'Welcome to the AI Insights Assistant. I can help you analyze crime and employment data relationships. What would you like to know?' 
    }
  ]);
        ...
        <div className="container-custom mx-auto px-4 md:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-white/80 max-w-2xl mx-auto">
              Leverage artificial intelligence to discover patterns and relationships in crime and employment data.
            </p>
          </div>
        </div>
      </div>
          ...
          >
            <div className="bg-eerie-black rounded-lg shadow-md border border-gray-800 p-5 mb-6">
              ...
              <p className="text-gray-300 mb-4">
                Our AI assistant analyzes relationships between crime statistics and employment data to provide insights that might not be immediately obvious.
              </p>
              <p className="text-gray-300 mb-4">
                Ask questions about trends, correlations, or specific data points to explore the complex relationship between crime and economic factors.
              </p>
              <div className="border-t border-gray-800 pt-4 mt-4">
                <h3 className="text-md font-semibold text-white mb-3">Sample Questions</h3>
            ...
            <div className="bg-eerie-black rounded-lg shadow-md border border-gray-800 p-5">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-white">How We Use AI</h3>
              </div>
              <p className="text-gray-300 text-sm mb-3">
                Our AI model has been trained on decades of historical crime and employment data to identify patterns and correlations.
              </p>
              <p className="text-gray-300 text-sm mb-3">
                We process this data through advanced machine learning algorithms to provide insights that can help inform policy decisions and research.
              </p>
              <p className="text-gray-300 text-sm">
                All insights are based on statistical analysis and should be considered as part of a broader research approach.
              </p>
            </div>
          </motion.div>
          ...
          >
              ...
              <div className="bg-hunter-green text-white px-5 py-3">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-sm">Analyzing crime and employment data correlations</p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-6 bg-eerie-black rounded-lg shadow-md border border-gray-800 p-5">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-white mb-2">Want More In-depth Analysis?</h3>
                  <p className="text-gray-300 mb-3">
                    The AI assistant provides quick insights, but our full reports offer deeper analysis with detailed methodology and source citations.
                  </p>
