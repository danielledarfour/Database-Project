...
const Card = ({
  ...
  return (
    <div
      ...
      style={{
        transform: isHovered
          ? `perspective(1000px) rotateX(${coords.y * 15}deg) rotateY(${
              coords.x * -15
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <div className="flex justify-between items-start mb-6">
          <div
            ...
            style={{
              transform: isHovered
                ? `translateX(${coords.x * -15}px) translateY(${
                    coords.y * -15
                  }px)`
                : "translateX(0) translateY(0)",
          ...
          <div
            ...
            style={{
              transform: isHovered
                ? `translateX(${coords.x * 20}px) translateY(${
                    coords.y * 20
                  }px)`
                : "translateX(0) translateY(0)",
              transition: "transform 0.3s ease",
        ...
        {statValue && statLabel && (
          <div
            ...
            style={{
              transform: isHovered
                ? `translateX(${coords.x * -10}px) translateY(${
                    coords.y * -10
                  }px)`
                : "translateX(0) translateY(0)",
              transition: "transform 0.3s ease",
...
const StyledWrapper = styled.div`
  ...
  .card {
    ...
    box-shadow: rgba(0, 0, 0, 0.4) 0px 30px 30px -10px,
      ${(props) =>
        props.$isHovered ? "0 0 30px rgba(16, 185, 129, 0.2)" : "none"};
    transition: all 0.5s ease;
    position: relative;
    overflow: hidden;
    transform: rotateY(${(props) => props.$mouseX * 20}deg)
      rotateX(${(props) => -props.$mouseY * 20}deg) translateZ(10px);
  }
  ...
  .glow {
    ...
    background: radial-gradient(
      circle at ${(props) => (props.$mouseX + 0.5) * 100}%
        ${(props) => (props.$mouseY + 0.5) * 100}%,
  ...
  .p1 {
    ...
    left: 20%;
    animation: ${(props) =>
      props.$isHovered ? "float1 5s ease-in-out infinite" : "none"};
  ...
  .p2 {
    ...
    left: 80%;
    animation: ${(props) =>
      props.$isHovered ? "float2 7s ease-in-out infinite" : "none"};
  ...
  .p3 {
    ...
    left: 10%;
    animation: ${(props) =>
      props.$isHovered ? "float3 6s ease-in-out infinite" : "none"};
  ...
  .p4 {
    ...
    left: 60%;
    animation: ${(props) =>
      props.$isHovered ? "float4 8s ease-in-out infinite" : "none"};
  ...
  @keyframes float1 {
    ...
    100% {
      transform: translate(50px, -50px) translateZ(30px);
      opacity: 0;
    }
  }
  ...
  @keyframes float2 {
    ...
    100% {
      transform: translate(-70px, -40px) translateZ(30px);
      opacity: 0;
    }
  }
  ...
  @keyframes float3 {
    ...
    100% {
      transform: translate(40px, -60px) translateZ(30px);
      opacity: 0;
    }
  }
  ...
  @keyframes float4 {
    ...
    100% {
      transform: translate(-50px, -70px) translateZ(30px);
      opacity: 0;
    }
  }
  ...
  .pulse {
    ...
    z-index: 1;
    animation: ${(props) =>
      props.$isHovered ? "pulse 1.5s ease-in-out infinite" : "none"};
  }
