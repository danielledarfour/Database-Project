...
const StyledWrapper = styled.div`
  ...
  .card1 {
    ...
    background: linear-gradient(275deg,rgba(70, 122, 70, 0.4), #121212);
    border-radius: 90px 5px 5px 5px;
    box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 5px -1px, rgba(0, 0, 0, 0.1) 0px 1px 3px -1px;
  ...
  .card2 {
    ...
    outline: none;
    border: 1px solid rgba(255, 255, 255, 0.3);
    background: linear-gradient(46deg,rgba(70, 122, 70, 0.4), #121212);
  ...
  .card3 {
    ...
    outline: none;
    border: 1px solid rgba(255, 255, 255, 0.3);
    background: linear-gradient(260deg,rgba(70, 122, 70, 0.4), #121212);
  ...
  .card4 {
    ...
    outline: none;
    border: 1px solid rgba(255, 255, 255, 0.3);
    background: linear-gradient(145deg,rgba(70, 122, 70, 0.4), #121212); 
  ...
  .card1:hover {
    cursor: pointer;
    scale: 1.05;
    background-color: rgba(204, 57, 164, 0.3); /* Instagram color, more transparent */
    border-color: #cc39a4;
  }
  ...
  .card2:hover {
    cursor: pointer;
    scale: 1.05;
    background-color: rgba(3, 169, 244, 0.3); /* Twitter color, more transparent */
    border-color: #03A9F4;
  }
  ...
  .card3:hover {
    cursor: pointer;
    scale: 1.05;
    background-color: rgba(50, 50, 50, 0.3); /* GitHub color, more transparent */
    border-color: #ffffff;
  }
  ...
  .card4:hover {
    cursor: pointer;
    scale: 1.05;
    background-color: rgba(140, 158, 255, 0.3); /* Discord color, more transparent */
    border-color: #8c9eff;
  }
