      ...
      <div className="container-custom mx-auto px-4 md:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-6 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-5 max-w-sm">
              Providing insightful data analysis on the correlation between
              crime rates and employment statistics across the United States.
            </p>
            <Button />
          </div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-aquamarine font-semibold uppercase tracking-wider mb-4">
              Quick Links
            </h3>
              ...
              <li>
                ...
                >
                  <span className="inline-flex items-center">
                    Test 404 Page
                    <svg
                      className="w-4 h-4 ml-1 text-aquamarine"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <div>
            ...
            <div className="space-y-3">
              <p className="text-gray-300 hover:text-white flex items-start">
                <svg
        ...
        <div className="border-t border-hunter-green pt-8 mt-12 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link
              to="#"
              className="text-gray-300 hover:text-aquamarine text-sm transition-colors"
            >
              Privacy Policy
            </Link>
            <Link
